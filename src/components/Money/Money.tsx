...
const Money: FC<MoneyProps> = (props) => {
  const { money, classNameText, moneyHeight, moneyWidth, classNameButton } = props;

  return (
    <div className={`${classNameButton} flex flex-row items-center gap-[6px] w-full justify-center`}>
